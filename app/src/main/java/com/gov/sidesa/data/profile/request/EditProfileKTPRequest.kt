...
data class EditProfileKTPRequest(
    ...
    @SerializedName("id_kelurahan") val villageId: Long? = null,
    @SerializedName("id_kecamatan") val districtId: Long? = null,
    @SerializedName("id_kota") val cityId: Long? = null,
    @SerializedName("id_provinsi") val provinceId: Long? = null,
